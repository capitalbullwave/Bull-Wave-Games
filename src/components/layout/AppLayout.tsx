      ...
      <div className="w-full sm:w-[400px] h-screen bg-[#fafafb] text-slate-800 flex flex-col relative shadow-[0_0_50px_rgba(0,0,0,0.25)] border-x border-slate-300/30 overflow-hidden">
        ...
        {pathname !== "/about" && pathname !== "/dragon-assistant" && !pathname?.includes("/activity/") && !pathname?.includes("/games/") && (
          <nav className="absolute bottom-0 left-0 right-0 h-16 bg-white border-t border-glass-border z-40 px-2 flex items-center justify-between shadow-[0_-5px_15px_rgba(0,0,0,0.05)]">
            ...
            <Link
              href="/lobby"
              className={`flex flex-col items-center justify-center w-14 gap-0.5 transition-colors ${(pathname === "/lobby" || pathname === "/") ? "text-[#800000]" : "text-muted-foreground hover:text-[#800000]"
                }`}
            >
              <Gamepad2 size={20} />
            ...
            <Link
              href="/activity"
              className={`flex flex-col items-center justify-center w-14 gap-0.5 transition-colors ${pathname?.startsWith("/activity") ? "text-[#800000]" : "text-muted-foreground hover:text-[#800000]"
                }`}
            >
              <Award size={20} />
            ...
            <Link
              href="/referrals"
              className={`flex flex-col items-center justify-center w-14 gap-0.5 transition-colors ${pathname?.startsWith("/referrals") ? "text-[#800000]" : "text-muted-foreground hover:text-[#800000]"
                }`}
            >
              <Users size={20} />
            ...
            <Link
              href="/profile"
              className={`flex flex-col items-center justify-center w-14 gap-0.5 transition-colors ${pathname?.startsWith("/profile") ? "text-[#800000]" : "text-muted-foreground hover:text-[#800000]"
                }`}
            >
              <UserCircle size={20} />
